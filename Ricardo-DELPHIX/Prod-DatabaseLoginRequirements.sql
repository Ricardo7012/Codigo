...
USE [master]
GO
CREATE LOGIN [IEHP\PDataMasking_RO] FROM WINDOWS WITH DEFAULT_DATABASE=[tempdb]
GO
...
USE [msdb]
GO
DROP USER [IEHP\PDataMasking_RO]
GO
USE [master]
GO
DROP USER [IEHP\PDataMasking_RO]
GO
DROP LOGIN [IEHP\PDataMasking_RO]
GO
USE [master]
GO
DROP LOGIN [IEHP\QDataMasking_SA]
GO
...
USE [master]
GO
CREATE LOGIN [IEHP\QDataMasking_SA] FROM WINDOWS WITH DEFAULT_DATABASE=[tempdb]
GO
ALTER SERVER ROLE [sysadmin] ADD MEMBER [IEHP\QDataMasking_SA]
GO
