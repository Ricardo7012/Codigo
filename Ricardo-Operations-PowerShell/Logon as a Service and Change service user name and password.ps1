...
 
Write-Host -ForegroundColor Green "######################## Logon as a service DONE! ###########################"
 
Write-Host -ForegroundColor Green "######################## Change service user name and password ###########################"
 
...
Write-Host -ForegroundColor Green "######################## Change service user name and password DONE! ###########################"
