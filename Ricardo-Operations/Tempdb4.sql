...
--If you see a lot of lines of output where the wait_type is 
--PAGELATCH_UP or PAGELATCH_EX, and the resource_description is 2:1:1 
--then that’s the PFS page (database ID 2 – tempdb, file ID 1, page ID 1), and if you see 2:1:3 then that’s another allocation page called an SGAM 
