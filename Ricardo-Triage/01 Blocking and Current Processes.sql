...
/*
SELECT hostname, cmd, spid, blocked,	waittime, waittype, waitresource, lastwaittype,
...
SELECT @@SERVERNAME AS SQLInstance, GETDATE() AS CurrentDateTime, @@Version AS VER, sqlserver_start_time FROM sys.dm_os_sys_info
