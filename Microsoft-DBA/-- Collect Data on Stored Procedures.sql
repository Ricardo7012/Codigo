-- Collect Data on Stored Procedures

SELECT TOP 100 GETDATE() AS 'Collection Date'
	, qs.last_execution_time AS 'Execution Time'
...
WHERE qs.last_execution_time > '12-11-2016'
	OR qs.execution_count > 50
...
SELECT * FROM #Detail d --WHERE d.[DB Name] = 'Accounting_Old'
