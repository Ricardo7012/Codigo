...
SELECT d.Dbname AS 'DB Name'
	, d.dbstatus AS 'DB Status'
	, d.Recovery_Model AS 'Recovery Model'
	, (file_size_mb + log_file_size_mb) AS 'DB Size'
	, d.file_Size_MB AS 'File Size (MB)'
	, d.Space_Used_MB AS 'Space Used (MB)'
	, d.Free_Space_MB AS 'Free Space (MB)'
	, l.Log_File_Size_MB AS 'Log File Size (MB)'
	, log_Space_Used_MB AS 'Log Space Used (MB)'
	, l.log_Free_Space_MB AS 'Log Free Space (MB)'
	, fs.Freespace AS 'DB Freespace'
FROM #dbsize d
