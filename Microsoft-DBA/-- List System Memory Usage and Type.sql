-- List System Memory Usage and Type

SELECT EventTime AS 'Event Time'
	, record.value('(/Record/ResourceMonitor/Notification)[1]', 'varchar(max)') AS 'Type'
	, record.value('(/Record/ResourceMonitor/IndicatorsProcess)[1]', 'int') AS 'Indicators Process'
	, record.value('(/Record/ResourceMonitor/IndicatorsSystem)[1]', 'int') AS 'Indicators System'
