-- Check When the Database was Last Restored

DECLARE @dbname SYSNAME
DECLARE @days INT

SET @dbname = 'Accounting_CW'-- Substitute Database Name you want or NULL for all Databases
SET @days = - 360 -- Previous number of days, script will default to 30
