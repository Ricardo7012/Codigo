...
#SQLMONITOR
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Core Services port: 9292" -Direction inbound –LocalPort 9292 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Core Services port: 9292" -Direction outbound –LocalPort 9292 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Web Application Service port: 9290" -Direction inbound –LocalPort 9290 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Web Application Service port: 9290" -Direction outbound –LocalPort 9290 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Web Application Monitor port: 9094" -Direction inbound –LocalPort 9094 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Web Application Monitor port: 9094" -Direction outbound –LocalPort 9094 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Web Application SSL port: 9291" -Direction inbound –LocalPort 9291 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR Dashboard Web Application SSL port: 9291" -Direction outbound –LocalPort 9291 -Protocol TCP -Action Allow

New-NetFirewallRule -DisplayName "SQLMONITOR ServicePort Services port: 5167" -Direction inbound –LocalPort 5167 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR ServicePort Services port: 5167" -Direction outbound –LocalPort 5167 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR managementServicePort Services port: 5166" -Direction inbound –LocalPort 5166 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR managementServicePort Services port: 5166" -Direction outbound –LocalPort 5166 -Protocol TCP -Action Allow

New-NetFirewallRule -DisplayName "SQLMONITOR RPC Services port: 1304" -Direction inbound –LocalPort 1304 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR RPC Services port: 1304" -Direction outbound –LocalPort 1304 -Protocol TCP -Action Allow

New-NetFirewallRule -DisplayName "SQLMONITOR RPC Services port: 135" -Direction inbound –LocalPort 135 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "SQLMONITOR RPC Services port: 135" -Direction outbound –LocalPort 135 -Protocol TCP -Action Allow

#Enable Windows Firewall
Set-NetFirewallProfile -DefaultInboundAction Block -DefaultOutboundAction Allow -NotifyOnListen True -AllowUnicastResponseToMulticast False
