...
-- DESCRIPTION: TempDB sizing and adding additional files based on no of cores
--	For <= 8 cores 
--	Tempdb data files = # of cores
--	For > 8 cores 
--	8 Tempdb data files
-- DATABASES USED: TempDB
...
set @TempDbLogFileSize = '1000MB'
set @TempDbDataFileGrowth = '1000MB'
set @TempDbLogFileGrowth = '1000MB'
