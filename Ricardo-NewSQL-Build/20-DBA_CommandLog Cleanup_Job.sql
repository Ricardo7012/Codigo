...
/****** Object:  Job [DBA_CommandLog Cleanup]    Script Date: 10/14/2021 10:19:55 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 10/14/2021 10:19:55 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DBA_CommandLog Cleanup]    Script Date: 10/14/2021 10:19:56 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DBA_CommandLog Cleanup', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Monthly', 
		...
		@schedule_uid=N'11d8e41c-8f17-4ed5-b90c-17bd1ad992ea'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
