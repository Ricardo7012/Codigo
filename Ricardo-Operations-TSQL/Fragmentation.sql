...
FROM sys.dm_db_index_physical_stats(DB_ID('AdventureWorks2019-NP'), NULL, NULL, NULL, NULL) AS indexstats
...
SELECT OBJECT_NAME(object_id)
     ...
     , page_count
FROM sys.dm_db_index_physical_stats(DB_ID(N'AdventureWorks2019-NP'), NULL, NULL, NULL, NULL) -- SEE ALL
