--This script will identify how much memory SQL Server is using as a whole and if SQL Server is experiencing memory pressures. 
--If the process_physical_memory_low and or process_virtual_memory_low columns have a "1" that indicates memory pressure. 
--This can be internal or external. For internal memory pressures use the query below:
SELECT
