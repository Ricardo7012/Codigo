...
#NEED TO RUN AS ADMINISISTRATOR AND INCLUDE SCOPE
#Install-Module -Name ExchangeOnlineManagement -Scope CurrentUser -RequiredVersion 2.0.5
 
Import-Module ExchangeOnlineManagement
#Connect-IPPSSession
Connect-IPPSSession -UserPrincipalName admin@M365x18011736.onmicrosoft.com
...
## https://github.com/PowerShell/vscode-powershell/issues/1626 - https://learn.microsoft.com/en-us/powershell/scripting/dev-cross-plat/vscode/using-vscode?view=powershell-7.3&viewFallbackFrom=powershell-6#installing-the-powershell-extension-on-restricted-systems